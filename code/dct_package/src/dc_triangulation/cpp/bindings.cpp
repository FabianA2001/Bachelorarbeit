...
PYBIND11_MODULE(_cpp_bindings, m)
{
      ...
      m.def("cadical_wrapper", &cadical_wrapper,
            ...
            pybind11::arg("number_vars"), pybind11::arg("number_edges_vars"), pybind11::arg("clauses"), pybind11::arg("edges"), pybind11::arg("save_state"), pybind11::arg("optimize_propagation"));
}