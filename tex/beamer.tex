...
\logo{\includegraphics{institut.png}}
...
\include{beamer_chapters/0-einleitung}
\include{beamer_chapters/1-Lösungsansätze}
\include{beamer_chapters/2-Instanzgenerierung}
\include{beamer_chapters/3-Auswertung}
\include{beamer_chapters/4-Fazit}
