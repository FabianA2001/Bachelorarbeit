...
\end{definition}
\begin{theorem}
	TODOGehört Sowas hier in? Soll ich sowas nennen
...
\begin{definition}[Grad]
	...
	Im folgenden wird er durch die Funktion \(deg: \mathbb{Z}^2 \longrightarrow \mathbb{Z}\) angegeben.
\end{definition}
\begin{definition}[Gradbeschränkte Triangulation]
	...
	Zusätzlich gibt es noch eine Funktion \(deg^*: \mathbb{Z}^2 \longrightarrow \mathbb{Z}\).
